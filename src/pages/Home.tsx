...
const subjects = [
  ...
  { id: 'pakistanhistory', name: 'Pakistan History', icon: BookOpenText, color: 'text-red-600', bg: 'bg-yellow-50', description: 'Pakistan History MCQs covering key events and personalities for competitive exams.' },
];
